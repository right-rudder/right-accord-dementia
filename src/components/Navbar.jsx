      ...
      >
        ...
        <div className="p-5 px-10 font-bold flex flex-col text-white justify-center align-middle items-center gap-5 overflow-hidden">
          ...
          {(LINKEDIN_URL ||
            ...
            TWITTER_URL ||
            YOUTUBE_URL) && (
            <div className="flex items-center lg:ml-9 justify-center align-middle gap-x-3">
              {LINKEDIN_URL && (
                <a
                  href={LINKEDIN_URL}
                  target="_blank"
                  aria-label="LinkedIn"
                  title="LinkedIn"
                  className="transition-colors duration-300 hover:text-blue-600 hover:scale-110"
                >
